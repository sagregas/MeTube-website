...
if($UserId){
		$Q3="select * from Media where Type = 'Audio' and Media.MediaID in (select Media.MediaID from Media where Sharing='Public' and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId') union select Media.MediaID from Media where Sharing ='Friends' and UploaderID in (select FriendID from Friends where UserID='$UserId') or UploaderID=$UserId and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId') union select Media.MediaID from Media where Sharing='Contacts' and UploaderID in (select ContactID from Contacts where UserID='$UserId') and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId')) order by UploadTime desc Limit 3";
		$Q4="select *,count(*) as cnt from Media inner join MediaStats on Media.MediaID=MediaStats.MediaID where Type='Audio' and LikeID!=0 and Media.MediaID in (select Media.MediaID from Media where Sharing='Public' and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId') union select Media.MediaID from Media where Sharing ='Friends' and UploaderID in (select FriendID from Friends where UserID='$UserId') or UploaderID=$UserId and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId') union select Media.MediaID from Media where Sharing='Contacts' and UploaderID in (select ContactID from Contacts where UserID='$UserId') and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId')) group by MediaStats.MediaID order by cnt limit 3";
		$Q5="select * from Media where Type='Audio' and Media.MediaID in (select Media.MediaID from Media where Sharing='Public' and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId') union select Media.MediaID from Media where Sharing ='Friends' and UploaderID in (select FriendID from Friends where UserID='$UserId') or UploaderID=$UserId and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId') union select Media.MediaID from Media where Sharing='Contacts' and UploaderID in (select ContactID from Contacts where UserID='$UserId') and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId')) order by Views desc limit 3";
		}
		else{
		$Q3="select * from Media where Type='Audio' and Sharing='Public' order by UploadTime desc Limit 3";
		$Q4="select *,count(*) as cnt from Media inner join MediaStats on Media.MediaID=MediaStats.MediaID where Type='Audio' and Sharing='Public' and LikeID!=0 group by MediaStats.MediaID order by cnt limit 3";
		$Q5="select * from Media where Type='Audio' and Sharing='Public' order by Views desc limit 3";
		}
...
<div class="container" style="margin-left:0 ">
				...
				<div class="col-md-4">
				    ...
				    <br>
					<a href="playaudio.php?id=<?php echo $value['MediaID'];?>">
			...
			foreach ($Q1res as $key => $value) {
				...
				$Q2="select * from Media where Channel='$channel' and Type='Audio' and Media.MediaID in (select Media.MediaID from Media where Sharing='Public' and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId') union select Media.MediaID from Media where Sharing ='Friends' and UploaderID in (select FriendID from Friends where UserID='$UserId') or UploaderID=$UserId and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId') union select Media.MediaID from Media where Sharing='Contacts' and UploaderID in (select ContactID from Contacts where UserID='$UserId') and UploaderID not in (select UserID from Blockedlist where BlockID='$UserId'))";
